...
import com.agoni.blog.exception.AlreadyExistsException;
import com.agoni.blog.exception.NotFoundException;
import com.agoni.blog.model.dto.IndependentSheetDTO;
...
import com.agoni.blog.model.vo.SheetDetailVO;
import com.agoni.blog.model.vo.SheetListVO;
import com.agoni.blog.repository.SheetRepository;
import com.agoni.blog.utils.MarkdownUtils;
...
@Slf4j
@Service
public class SheetServiceImpl extends BasePostServiceImpl<Sheet> implements com.agoni.blog.service.SheetService {

    private final SheetRepository sheetRepository;

    private final ApplicationEventPublisher eventPublisher;

    private final com.agoni.blog.service.SheetCommentService sheetCommentService;

    private final com.agoni.blog.service.SheetMetaService sheetMetaService;

    private final com.agoni.blog.service.ThemeService themeService;

    private final com.agoni.blog.service.OptionService optionService;

    public SheetServiceImpl(SheetRepository sheetRepository,
            ApplicationEventPublisher eventPublisher,
            com.agoni.blog.service.SheetCommentService sheetCommentService,
            com.agoni.blog.service.SheetMetaService sheetMetaService,
            com.agoni.blog.service.ThemeService themeService,
            com.agoni.blog.service.OptionService optionService) {
