...
import com.agoni.blog.model.dto.BackupDTO;
import com.agoni.blog.model.dto.post.BasePostDetailDTO;
import com.agoni.blog.model.entity.*;
...
import com.agoni.blog.utils.DateTimeUtils;
import com.agoni.blog.utils.HaloUtils;
import com.agoni.blog.utils.JsonUtils;
...
public class BackupServiceImpl implements BackupService {
    ...
    public BackupDTO backupWorkDirectory() {
        ...
        try {
            ...
            // Zip halo
            com.agoni.blog.utils.FileUtils.zip(Paths.get(this.haloProperties.getWorkDir()), haloZipPath);
    ...
    public void deleteWorkDirBackup(String fileName) {
        ...
        com.agoni.blog.utils.FileUtils.checkDirectoryTraversal(backupRootPath, backupPath);
    ...
    public Resource loadFileAsResource(String basePath, String fileName) {
        ...
        try {
            ...
            // Check directory traversal
            com.agoni.blog.utils.FileUtils.checkDirectoryTraversal(backupParentPath, backupFilePath);
    ...
    public void deleteExportedData(String fileName) {
        ...
        com.agoni.blog.utils.FileUtils.checkDirectoryTraversal(dataExportRootPath, backupPath);
