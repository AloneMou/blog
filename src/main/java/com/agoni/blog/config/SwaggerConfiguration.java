...
public class SwaggerConfiguration {
    ...
    public Docket haloDefaultApi() {
        ...
        return buildApiDocket("com.agoni.blog.content.api",
                "com.agoni.blog.controller.content.api",
                "/api/content/**")
    ...
    public Docket haloAdminApi() {
        ...
        return buildApiDocket("com.agoni.blog.admin.api",
                "com.agoni.blog.controller.admin",
                "/api/admin/**")
