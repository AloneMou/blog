...
public interface PostCategoryRepository extends BaseRepository<PostCategory, Integer> {
    ...
    @Query("select new com.agoni.blog.model.projection.CategoryPostCountProjection(count(pc.postId), pc.categoryId) from PostCategory pc group by pc.categoryId")
    @NonNull
